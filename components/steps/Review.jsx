...
const ResumePreview = ({ resumeRef, cvData }) => {
    ...
    const displayData = {
        ...
        address: [personalInfo.address, personalInfo.city, personalInfo.state, personalInfo.zipCode, personalInfo.country]
            .filter(Boolean)
            .join(', ') || 'Your Address',
        portfolio: personalInfo.portfolio || 'your-portfolio.com',
        linkedin: personalInfo.linkedin || 'linkedin.com/in/yourprofile',
        careerSummary: careerSummary || "Please add your career summary to showcase your professional background and expertise.",
    }
                ...
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-1 text-xs text-gray-700">
                        <div className="flex items-center gap-1">
                            <span className="font-semibold"><Phone size="14" /></span>
                            <span>{displayData.phone}</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <span className="font-semibold"><Mail size="14" /></span>
                            <span>{displayData.email}</span>
                        </div>
                        <div className="flex items-start gap-1 col-span-2">
                            <span className="font-semibold"><MapPinHouse size="14" /></span>
                                    ...
                                    <div key={index}>
                                        <div className="flex justify-between items-start mb-0.5">
                                            <p className="font-bold text-xs text-gray-900">
                                                {cert.title || cert.name || 'Certification Name'}
                                            </p>
                                            <p className="text-[10px] text-gray-600 font-semibold whitespace-nowrap ml-2">
...
export default function Review() {
    ...
    //         address: 'House-79/B, Road-01',
    //         city: 'Mirpur, Dhaka',
    //         country: 'Bangladesh',
    //         portfolio: 'dribbble.com/saifur_info',
    //         linkedin: 'linkedin.com/in/saifur',
    //     },
    //     jobTitle: 'UI/UX Designer',
    //     careerSummary: "Hello! I'm a Professional UI/UX Designer & Graphics Designer with a keen eye for detail and a drive for creativity.",
    ...
    //         startDate: '2022',
    //         endDate: 'Present',
    //         description: 'Working on various design projects'
    //     }],
    //     certifications: [],
    //     generatedResume: '' 
    // }
    ...
    const isAIEnhanced = cvData.isAIEnhanced || false
