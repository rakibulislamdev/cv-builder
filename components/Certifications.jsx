                ...
                <CardContent>
                    <form onSubmit={onSubmit} className="space-y-8">
                        {certifications.map((cert, index) => (
                            <div key={index} className="space-y-6 relative border-b pb-6 mb-6">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor={`title-${index}`} className="text-sm font-medium text-gray-700">Certification Title</Label>
                                    <Input
                                        id={`title-${index}`}
                                        placeholder="e.g., High BNCC"
                                        value={cert.title}
                                        onChange={(e) => updateCertificationItem(index, "title", e.target.value)}
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor={`organization-${index}`} className="text-sm font-medium text-gray-700">Issuing Organization</Label>
                                    <Input
                                        id={`organization-${index}`}
                                        placeholder="e.g., Dhaka University"
                                        value={cert.organization}
                                        onChange={(e) => updateCertificationItem(index, "organization", e.target.value)}
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-700">Certificate Issue</Label>
                                            ...
                                            <Popover>
                                                ...
                                                <PopoverContent className="w-auto p-0" align="start">
                                                    <Calendar
                                                        ...
                                                        onSelect={(date) => updateCertificationItem(index, "issueDate", date)}
                                                        initialFocus
                                                    />
                                                </PopoverContent>
                                            </Popover>
                                            ...
                                            <Popover>
                                                ...
                                                <PopoverContent className="w-auto p-0" align="start">
                                                    <Calendar
                                                        ...
                                                        onSelect={(date) => updateCertificationItem(index, "expiryDate", date)}
                                                        initialFocus
                                                    />
                                                </PopoverContent>
                                            </Popover>
                        ...
                        <div className="flex justify-start">
                            <Button type="button" onClick={addCertification} variant="link" className="text-green-500 px-0">
                                <Plus className="h-5 w-5 mr-2 text-green-500" />
                                <span className="font-medium text-green-500">Add Another Certification</span>
                            </Button>
                        </div>

                        {/* Navigation Buttons */}
                        <div className="flex justify-end pt-6">
                            <Button type="submit" className="bg-green-500 hover:bg-green-600 px-8 text-white font-medium">
                                Next
